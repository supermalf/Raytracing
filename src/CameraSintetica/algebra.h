 ...
 *
 *   @author Maira Noronha e Marcelo Gattass
 *
 *   @date
 *         Criado em:         Mar2003
...
/**
 * Matriz de rotacao em torno de um eixo (angle em graus) .
 */
...
void algVectorWrite(FILE* fp, char *text, Vector v);
...
void algMatrixWrite(FILE* fp, char *text, Matrix m);
...
/*
 * obetem um vetor no formato do OpenGL
 */
void algGetOGLVector(Vector vector, float v[4]);
